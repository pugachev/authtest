  ...
  <header>
    ...
    <main>
        ...
        <div class="container mt-5 p-lg-5 bg-light">
            ...
            <form method="post" action="{{ url('/verification/update', $selectRecord->id) }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('patch') }}
                <!--氏名-->
                <div class="form-row">
                    ...
                    <div class="mb-3">
                        <div class="mb-3">
                            <!-- <img  class="mb-3" id="targetImg" src="../../../public/storage/{{$selectRecord->imgpath}}" width="256 height=""> -->
                            <img  class="mb-3" id="targetImg" src="{{ old('imgpath', $selectRecord->imgpath) }}" width="256 height="">
