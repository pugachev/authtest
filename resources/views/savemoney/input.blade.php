  ...
  <header>
    ...
    <main>
        ...
        <div class="container mt-5 p-lg-5 bg-light">
            ...
            <form method="post" action="{{ url('/verification/store') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
                <!--氏名-->
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label for="inputMoney">金額</label>
                        <input type="text" class="form-control" name="inputMoney" id="inputMoney" placeholder="金額">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="inputDate">日時</label>
                        <input type="text" class="form-control" name="inputDate" id="inputDate" placeholder="日時">
                    </div>
                    <div class="mb-3">
                        <div class="mb-3">
                            <img  class="mb-3" id="targetImg" src="" width="256 height="">
